  ...
  Widget build(BuildContext context) {
    return  Container(
      ...
      child: Wrap(
        ...
        children: <Widget>[
          for(int i=0;i<newTaipei_districtlist.length;i++)
            InputChip(
                selected: newTaipei_districtlist[i][1],
                label: Text(newTaipei_districtlist[i][0]+"區"),
                ...
                onPressed: () {
                  ...
                  setState(() {
                    newTaipei_districtlist[i][1] = !newTaipei_districtlist[i][1];
                    print(newTaipei_districtlist[i][0]+' is '+(newTaipei_districtlist[i][1]).toString(),);
                  });
                }
            ),
        ],
